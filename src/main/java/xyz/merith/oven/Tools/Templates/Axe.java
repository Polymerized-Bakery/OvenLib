...
/**
 * A custom implementation of an {@link AxeItem} that integrates with the Polymer API for custom item models.
 */
public class Axe extends AxeItem implements PolymerItem {

    // TODO: setup bool to not include texture
    /**
     * Constructs a new Axe item with the specified properties.
     *
     * @param polymerItem the item to use as the base for the Polymer model
     * @param material    the material of the axe
     ...
     */
    public Axe(Item polymerItem, ToolMaterial material, Item.Settings settings, String namespace, String toolName) {
