...
/**
 * A custom implementation of an {@link PickaxeItem} that integrates with the Polymer API for custom item models.
 */
public class Pickaxe extends PickaxeItem implements PolymerItem {

    /**
     * Constructs a new Pickaxe item with the specified properties.
     *
     * @param polymerItem the item to use as the base for the Polymer model
     * @param material    the material of the pickaxe
     ...
     */
    public Pickaxe(Item polymerItem, ToolMaterial material, Item.Settings settings, String namespace, String toolName) {
